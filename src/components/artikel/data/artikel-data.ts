...
export const nounData: NounItem[] = [
  { id: "tisch", noun: "Tisch", article: "der", plural: "Tische", translation: "mesa", translationEn: "table", category: "Zuhause", level: "A1", example: "Der Tisch steht am Fenster." },
  { id: "stift", noun: "Stift", article: "der", plural: "Stifte", translation: "bolígrafo", translationEn: "pen", category: "Lernen", level: "A1", example: "Der Stift liegt auf dem Tisch." },
  { id: "apfel", noun: "Apfel", article: "der", plural: "Äpfel", translation: "manzana", translationEn: "apple", category: "Essen", level: "A1", example: "Der Apfel ist frisch." },
  { id: "schluessel", noun: "Schlüssel", article: "der", plural: "Schlüssel", translation: "llave", translationEn: "key", category: "Alltag", level: "A1", example: "Ich suche den Schlüssel." },
  { id: "linguist", noun: "Linguist", article: "der", plural: "Linguisten", translation: "lingüista", translationEn: "linguist", category: "Beruf", level: "B1", example: "Der Linguist untersucht Sprachen." },
  { id: "zeitung", noun: "Zeitung", article: "die", plural: "Zeitungen", translation: "periódico", translationEn: "newspaper", category: "Medien", level: "A1", example: "Die Zeitung liegt vor der Tür." },
  { id: "freiheit", noun: "Freiheit", article: "die", plural: "Freiheiten", translation: "libertad", translationEn: "freedom", category: "Abstrakt", level: "B1", example: "Die Freiheit ist sehr wichtig." },
  { id: "moeglichkeit", noun: "Möglichkeit", article: "die", plural: "Möglichkeiten", translation: "posibilidad", translationEn: "possibility", category: "Abstrakt", level: "B1", example: "Das ist eine gute Möglichkeit." },
  { id: "schule", noun: "Schule", article: "die", plural: "Schulen", translation: "escuela", translationEn: "school", category: "Lernen", level: "A1", example: "Die Schule beginnt um acht Uhr." },
  { id: "flasche", noun: "Flasche", article: "die", plural: "Flaschen", translation: "botella", translationEn: "bottle", category: "Alltag", level: "A1", example: "Die Flasche ist leer." },
  { id: "buch", noun: "Buch", article: "das", plural: "Bücher", translation: "libro", translationEn: "book", category: "Lernen", level: "A1", example: "Das Buch ist interessant." },
  { id: "maedchen", noun: "Mädchen", article: "das", plural: "Mädchen", translation: "chica", translationEn: "girl", category: "Personen", level: "A1", example: "Das Mädchen liest ein Buch." },
  { id: "instrument", noun: "Instrument", article: "das", plural: "Instrumente", translation: "instrumento", translationEn: "instrument", category: "Musik", level: "A2", example: "Das Instrument klingt schön." },
  { id: "auto", noun: "Auto", article: "das", plural: "Autos", translation: "coche", translationEn: "car", category: "Verkehr", level: "A1", example: "Das Auto steht vor dem Haus." },
  { id: "ergebnis", noun: "Ergebnis", article: "das", plural: "Ergebnisse", translation: "resultado", translationEn: "result", category: "Abstrakt", level: "A2", example: "Das Ergebnis überrascht mich." },
  { id: "student", noun: "Student", article: "der", plural: "Studenten", translation: "estudiante", translationEn: "student", category: "Personen", level: "A1", example: "Der Student lernt in der Bibliothek." },
  { id: "wohnung", noun: "Wohnung", article: "die", plural: "Wohnungen", translation: "vivienda", translationEn: "apartment / flat", category: "Zuhause", level: "A1", example: "Die Wohnung ist sehr hell." },
  { id: "broetchen", noun: "Brötchen", article: "das", plural: "Brötchen", translation: "panecillo", translationEn: "bread roll", category: "Essen", level: "A1", example: "Das Brötchen schmeckt gut." },
];
